	...
	<div class="row">
		...
		<?php
			...
			foreach ($articles as $article){
				...
				echo "<a class=\"btn btn-default\" href=\"delete_article_action.php?id=" . $article['id'] . "\">Supprimer l'article</a>";
				echo "<a class=\"btn btn-default\" href=\"update_article.php?id=" . $article['id'] . "\">Modifier l'article</a>";
